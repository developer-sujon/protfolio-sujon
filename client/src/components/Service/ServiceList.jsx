...
const ServiceList = () => {
  ...
  useEffect(() => {
    ServiceRequest.ServiceList(pageNumber, perPage, searchKey);
  }, [pageNumber, perPage, searchKey]);

  const { ServiceList, TotalService } = useSelector((state) => state.Service);
  ...
  const deleteEducaion = (id) => {
    AleartMessage.deleteAleart(ServiceRequest.ServiceDelete, id).then(() => {
      ServiceRequest.ServiceList(pageNumber, perPage, searchKey);
    });
  };
          ...
          <div className="card">
            <div className="card-body">
              <div className="container-fluid">
                <div className="row">
                  <div className="col-6">
                    <h5>My Educaiton List {TotalService}</h5>
                  </div>
                  <div className="col-2">
                    <select
                  ...
                  <div className="col-12 mt-5">
                    <nav aria-label="Page navigation example">
                      <ReactPaginate
                        ...
                        pageCount={TotalService / perPage}

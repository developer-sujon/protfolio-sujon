...
const BlogList = () => {
  ...
  useEffect(() => {
    BlogRequest.BlogList(pageNumber, perPage, searchKey);
  }, [pageNumber, perPage, searchKey]);

  const { BlogList, TotalBlog } = useSelector((state) => state.Blog);
  ...
  const deleteEducaion = (id) => {
    AleartMessage.deleteAleart(BlogRequest.BlogDelete, id).then(() => {
      BlogRequest.BlogList(pageNumber, perPage, searchKey);
    });
  };
          ...
          <div className="card">
            <div className="card-body">
              <div className="container-fluid">
                <div className="row">
                  <div className="col-6">
                    <h5>My Educaiton List {TotalBlog}</h5>
                  </div>
                  <div className="col-2">
                    <select
